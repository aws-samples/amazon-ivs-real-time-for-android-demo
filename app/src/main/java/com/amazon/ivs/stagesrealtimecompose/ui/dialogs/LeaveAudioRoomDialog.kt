...
@Composable
fun LeaveAudioRoomDialog() {
    Column(
        horizontalAlignment = Alignment.CenterHorizontally
    ) {
        Text(
            text = stringResource(R.string.leave_current_room),
            style = RobotoPrimary,
        )
        ButtonPrimary(
            ...
            onClick = StageHandler::leaveAudioRoom
        )
        ButtonPrimary(
...
@Preview
@Composable
private fun LeaveAudioRoomDialogPreview() {
    PreviewSurface {
        LeaveAudioRoomDialog()
    }
}
